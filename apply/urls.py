...
urlpatterns = [
    ...
    path('applicant/<int:apply_id>/', views.applicant_details, name='applicant_details'),
    path('applicant_delete/<int:apply_id>/', views.delete_applicant, name='delete_applicant'),
]